...
namespace OpenWeatherApi
{
    ...
    public partial class OpenWeatherApiClient 
    {
        private string _baseUrl = "http://api.openweathermap.org/";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public OpenWeatherApiClient(System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = _baseUrl; 
        ...
        /// <returns>Definition generated from Swagger Inspector</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<WeatherModel> WeatherAsync(string appid, string lon, string units, string lat)
        {
            return WeatherAsync(appid, lon, units, lat, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Definition generated from Swagger Inspector</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<WeatherModel> WeatherAsync(string appid, string lon, string units, string lat, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/data/2.5/weather?");
            if (appid != null) 
            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<WeatherModel>(response_, headers_).ConfigureAwait(false);
        ...
        /// <returns>Definition generated from Swagger Inspector</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<HourlyWeatherModel> OnecallAsync(string appid, string lon, string exclude, string lat, string units)
        {
            return OnecallAsync(appid, lon, exclude, lat, units, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Definition generated from Swagger Inspector</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<HourlyWeatherModel> OnecallAsync(string appid, string lon, string exclude, string lat, string units, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/data/2.5/onecall?");
            if (appid != null) 
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("appid") + "=").Append(System.Uri.EscapeDataString(ConvertToString(appid, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<HourlyWeatherModel>(response_, headers_).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.1.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class HourlyWeatherModel 
    {
        [Newtonsoft.Json.JsonProperty("lat", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? Lat { get; set; }
        ...
        public System.Collections.Generic.ICollection<Hourly> Hourly { get; set; }
    ...
    public partial class Hourly 
    {
        ...
        [Newtonsoft.Json.JsonProperty("uvi", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("wind_deg", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? Wind_deg { get; set; }
    
        [Newtonsoft.Json.JsonProperty("weather", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Weather2> Weather { get; set; }
    ...
    {
        [Newtonsoft.Json.JsonProperty("1h", Required = Newtonsoft.Json.Required.Always)]
